    ...
    <div class="container-fluid" id="content_list">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><div class="row noticeList">
                <a href="notice-detail.html">
                    ...
                    <div class="col-xs-10">
                        <p class="title"><a href="<?php echo U('Service/detail',array('id'=>$list['id']));?>" class="navbar-link"><?php echo ($list["title"]); ?></a></p>
...
<script type="application/javascript">
    var p = 1;
    var url = '/wchat.php?s=/Service/index';
    var inner_url = '/wchat.php?s=/Service/detail';
    //将时间戳转换为本地时间
