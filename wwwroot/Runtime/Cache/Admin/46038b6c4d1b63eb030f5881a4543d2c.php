                        ...
                        <div id="tab1" class="tab-pane tab1 in">
                            ...
                            <div class="form-item cf">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="hidden" name="image" id="cover_id_path" value="<?php echo ($info["image"]); ?>"/>
                                ...
                                <div class="form-item cf">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="text time" name="end_time" value="<?php echo ($info["end_time"]); ?>"></div>
                                </div>
                                <div class="form-item cf">
                                    <label class="item-label">联系人电话</label>
                                    <div class="controls">
                                        <input type="text" class="text input-large" name="tel" value="<?php echo ($info["tel"]); ?>"></div>
                                </div>
                            </div>
                            <div class="form-item cf">
